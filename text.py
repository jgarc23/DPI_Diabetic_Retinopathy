...
image_desc = [ 
"Small bulges in the blood vessels of the retina, caused by weakened capillary walls, and are an early sign of diabetic retinopathy.",
# Microaneursysms description

"Also known as cotton wool spots, are fluffy white patches on the retina caused by nerve fiber swelling due to inadequate blood supply.",
# Soft exudates description

"In the eye, blood vessels are critical for supplying the retina with oxygen and nutrients.",
# Blood Vessles description

"The optic disc is where the optic nerve fibers exit the retina, appearing as a small, round, pale area. It transmits visual information from the retina to the brain.",
# Optical disk description

"Yellowish deposits of lipids and proteins that leak from damaged blood vessels in the retina, often seen in diabetic retinopathy.",
